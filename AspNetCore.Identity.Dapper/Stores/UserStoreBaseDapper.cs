...
namespace AspNetCore.Identity.Dapper.Stores
{
    ...
    public abstract class UserStoreBaseDapper<TUser, TKey, TUserClaim, TUserLogin, TUserToken> :
        ...
        where TUserToken : IdentityUserToken<TKey>, new()
    {
        ...
        public UserStoreBaseDapper(IdentityErrorDescriber describer)
        {
        ...
        protected abstract Task<TUserLogin> FindUserLoginAsync(TKey userId, string loginProvider, string providerKey,
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
        /// <returns>The user login if it exists.</returns>
        protected abstract Task<TUserLogin> FindUserLoginAsync(string loginProvider, string providerKey,
            CancellationToken cancellationToken);
        ...
        #region UserAuthenticationTokenStore
        ...
        #region UserTwoFactorRecoveryCodeStore
    ...
    public abstract class UserStoreBaseDapper<TUser, TRole, TKey, TUserClaim, TUserRole, TUserLogin, TUserToken, TRoleClaim> :
        UserStoreBaseDapper<TUser, TKey, TUserClaim, TUserLogin, TUserToken>,
        ...
        where TRoleClaim : IdentityRoleClaim<TKey>, new()
    {
        ...
        /// </summary>
        /// <param name="describer">The <see cref="IdentityErrorDescriber"/> used to describe store errors.</param>
        public UserStoreBaseDapper(IdentityErrorDescriber describer) : base(describer)
        {
        }
        ...
        protected abstract Task<TUserRole> FindUserRoleAsync(TKey userId, TKey roleId,
            CancellationToken cancellationToken);
