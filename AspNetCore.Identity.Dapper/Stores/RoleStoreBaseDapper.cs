...
namespace AspNetCore.Identity.Dapper.Stores
{
    ...
    public abstract class RoleStoreBaseDapper<TRole, TKey, TUserRole, TRoleClaim> :
        IRoleStore<TRole>,
    ...
    {
        /// <summary>
        /// Constructs a new instance of <see cref="RoleStoreBaseDapper{TRole, TKey, TUserRole, TRoleClaim}"/>.
        /// </summary>
        /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
        public RoleStoreBaseDapper(IdentityErrorDescriber describer)
        {
        ...
        public abstract Task<TRole> FindByIdAsync(string roleId, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
        /// <returns>A <see cref="Task{TResult}"/> that result of the look up.</returns>
        public abstract Task<TRole> FindByNameAsync(string normalizedRoleName,
